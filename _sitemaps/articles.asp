...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  Con_Open()
    ...
    RS_Open 1, "SELECT TOP 2500 aaID, aaDatumPublicerad " & _
               "FROM cms_Artiklar " & _
               "WHERE aaStatus = 4 " & _
               "AND aaDatumPublicerad <= '" & Now & "' " & _
               "ORDER BY aaDatumPublicerad DESC", False
  ...
  <url>
    <loc>http://www.n-forum.se/avdelning/artiklar/default.asp</loc>
  ...
  <% If any_Txt Then %>
    <% For zx = 0 To UBound(list_Txt, 2) %>
      <url>
        <loc>http://www.n-forum.se/avdelning/artiklar/artikel_visa.asp?e=<% = list_Txt(0,zx) %></loc>
